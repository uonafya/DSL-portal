 ...
 * @author duncan
 */
public class DeliveriesConductedBySkilledHealthAttendants implements Metadata {

    final static Logger log = Logger.getLogger(DeliveriesConductedBySkilledHealthAttendants.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Deliveries Conducted By Skilled Health Attendants metadata fetcher");
       ...
       indicator.put("xaxis", pType);
        ...
        String title= "Deliveries conducted by skilled health attendants ";
        if(pType=="month"){
