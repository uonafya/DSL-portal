 ...
 * @author duncan
 */
public class ProportionoftestedforHIVTBpatient implements Metadata {

    final static Logger log = Logger.getLogger(ProportionoftestedforHIVTBpatient.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("PMTCT ARV Prophylaxis Rate (Infant)");
        ...
        indicator.put("title", "PMTCT ARV Prophylaxis Rate (Infant)");
