 ...
 * @author duncan
 */
public class ProportionofTBpatientHIVwhoareonCPT implements Metadata {

    final static Logger log = Logger.getLogger(ProportionofTBpatientHIVwhoareonCPT.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Proportion of TB patient HIV+ who are on CPT");
        ...
        String title="Proportion of TB patient HIV+ who are on CPT ";
         if(pType=="month"){
