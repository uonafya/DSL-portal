package com.healthit.metadata.indicators.humanworkforce;
 ...
 * @author duncan
 */
public class CadreDistribution implements Metadata {

    final static Logger log = Logger.getLogger(CadreDistribution.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Cadre Distribution metadata fetcher");
