 ...
 * @author duncan
 */
public class ProportionofWomenProvidedWithIPT2DuringTheANCVisits implements Metadata {

    final static Logger log = Logger.getLogger(ProportionofWomenProvidedWithIPT2DuringTheANCVisits.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Proportion of women provided with IPT2 during the ANC visits");
        ...
        String title= "IP - Proportion of women provided with IPT2 during the ANC visits ";
         if(pType=="month"){
