 ...
 * @author duncan
 */
public class FacilityMaternalMortalityRatio implements Metadata {

    final static Logger log = Logger.getLogger(FacilityMaternalMortalityRatio.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Facility Maternal Mortality Ratio metadata fetcher");
        ...
        indicator.put("title", "Facility Maternal Mortality Ratio");
