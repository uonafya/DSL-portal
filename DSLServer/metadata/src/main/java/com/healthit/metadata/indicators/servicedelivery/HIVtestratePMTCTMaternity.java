 ...
 * @author duncan
 */
public class HIVtestratePMTCTMaternity implements Metadata {

    final static Logger log = Logger.getLogger(HIVtestratePMTCTMaternity.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("HIV+ test rate - PMTCT-Maternity");
        ...
        String title="HIV+ test rate - PMTCT-Maternity ";
         if(pType=="month"){
