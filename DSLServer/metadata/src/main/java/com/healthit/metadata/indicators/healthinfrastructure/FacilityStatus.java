 ...
 * @author duncan
 */
public class FacilityStatus implements Metadata {

    final static Logger log = Logger.getLogger(FacilityStatus.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Facility Status metadata fetcher");
        ...
        indicator.put("subject", "facility_status"); // converter helper data
        indicator.put("dataname", "facility_count"); // converter helper data
        indicator.put("title", "Facilities By Status");
