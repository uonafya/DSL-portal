 ...
 * @author duncan
 */
public class EacArvsToHIVMotherDuringPregnancy implements Metadata {
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Eac Arvs To HIV Mother During Pregnancy metadata fetcher");
        ...
        indicator.put("title", "EAC ARVs to HIV positive mother during pregnancy");
