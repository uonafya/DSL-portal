 ...
 * @author duncan
 */
public class FemaleInfantsBelow6monthsBreastfeedding implements Metadata {

    final static Logger log = Logger.getLogger(FemaleInfantsBelow6monthsBreastfeedding.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Female Infants Below 6 months Breastfeedding metadata fetcher");
        ...
        indicator.put("title", "Female Infants below 6months on exclusive breastfeedding");
