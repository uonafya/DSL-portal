 ...
 * @author duncan
 */
public class UnderFiveAttendingCW implements Metadata {

    final static Logger log = Logger.getLogger(UnderFiveAttendingCW.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Under Five Attending CW metadata fetcher");
