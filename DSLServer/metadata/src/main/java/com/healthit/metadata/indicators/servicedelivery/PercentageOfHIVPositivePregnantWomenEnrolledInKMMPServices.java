 ...
 * @author duncan
 */
public class PercentageOfHIVPositivePregnantWomenEnrolledInKMMPServices implements Metadata {

    final static Logger log = Logger.getLogger(PercentageOfHIVPositivePregnantWomenEnrolledInKMMPServices.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Percentage of HIV-positive pregnant women enrolled in KMMP services");
        ...
        indicator.put("title", "Percentage of HIV-positive pregnant women enrolled in KMMP services");
