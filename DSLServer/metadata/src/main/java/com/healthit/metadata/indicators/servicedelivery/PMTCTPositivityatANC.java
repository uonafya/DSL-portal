 ...
 * @author duncan
 */
public class PMTCTPositivityatANC implements Metadata {

    final static Logger log = Logger.getLogger(PMTCTPositivityatANC.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("PMTCT Positivity at ANC");
        ...
        indicator.put("title", "PMTCT Positivity at ANC");
