 ...
 * @author duncan
 */
public class PMTCTPositivityInfants implements Metadata {

    final static Logger log = Logger.getLogger(PMTCTPositivityInfants.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("PMTCT Positivity Infants");
