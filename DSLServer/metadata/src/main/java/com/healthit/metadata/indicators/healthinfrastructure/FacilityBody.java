package com.healthit.metadata.indicators.healthinfrastructure;
 ...
 * @author duncan
 */
public class FacilityBody implements Metadata {

    final static Logger log = Logger.getLogger(FacilityBody.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Facility body metadata fetcher");
        ...
        indicator.put("subject", "regulating_body"); // converter helper data
        indicator.put("dataname", "facility_count"); // converter helper data
        indicator.put("title", "Facilities By Regulatory Body");
