 ...
 * @author duncan
 */
public class FreshStillBirthRate implements Metadata {

    final static Logger log = Logger.getLogger(FreshStillBirthRate.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Fresh Still Birth Rate metadata fetcher");
        ...
        String title="Fresh still Birth Rate ";
         if(pType=="month"){
