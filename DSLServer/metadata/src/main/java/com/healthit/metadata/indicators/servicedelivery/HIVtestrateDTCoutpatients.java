 ...
 * @author duncan
 */
public class HIVtestrateDTCoutpatients implements Metadata {

    final static Logger log = Logger.getLogger(HIVtestrateDTCoutpatients.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("HIV+ test rate - DTC outpatients");
        ...
        String title="HIV+ test rate - DTC outpatients ";
         if(pType=="month"){
