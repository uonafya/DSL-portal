 ...
 * @author duncan
 */
public class PMTCTMFRate implements Metadata {

    final static Logger log = Logger.getLogger(PMTCTMFRate.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        ...
        indicator.put("title", "PMTCT MF Rate");
