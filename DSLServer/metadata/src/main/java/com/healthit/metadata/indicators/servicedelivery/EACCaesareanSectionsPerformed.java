 ...
 * @author duncan
 */
public class EACCaesareanSectionsPerformed implements Metadata {

    final static Logger log = Logger.getLogger(EACCaesareanSectionsPerformed.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        ...
        String title ="EAC Caesarean Sections performed ";
         if(pType=="month"){
