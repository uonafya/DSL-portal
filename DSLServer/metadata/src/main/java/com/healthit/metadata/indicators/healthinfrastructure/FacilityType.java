 ...
 * @author duncan
 */
public class FacilityType implements Metadata {
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Facility Type metadata fetcher");
        ...
        indicator.put("subject", "facility_type"); // converter helper data
        ...
        indicator.put("xaxis-alternative", "Facilities By Type");
