 ...
 * @author duncan
 */
public class SmearPositivePulmonaryTB implements Metadata {

    final static Logger log = Logger.getLogger(SmearPositivePulmonaryTB.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Smear Positive Pulmonary TB");
        ...
        String title="Smear Positive Pulmonary TB ";
         if(pType=="month"){
