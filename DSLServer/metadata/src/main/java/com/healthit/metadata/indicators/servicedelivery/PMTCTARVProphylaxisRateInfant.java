 ...
 * @author duncan
 */
public class PMTCTARVProphylaxisRateInfant implements Metadata {

    final static Logger log = Logger.getLogger(PMTCTARVProphylaxisRateInfant.class.getCanonicalName());
