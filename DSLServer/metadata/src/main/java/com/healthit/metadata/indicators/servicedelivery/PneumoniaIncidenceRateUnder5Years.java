 ...
 * @author duncan
 */
public class PneumoniaIncidenceRateUnder5Years implements Metadata {

    final static Logger log = Logger.getLogger(PneumoniaIncidenceRateUnder5Years.class.getCanonicalName());
    ...
    public List<Object> getMetadata(RequestEntity requestString) {
        log.info("Pneumonia incidence rate under 5 years");
